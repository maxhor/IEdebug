                    ...
                    if (aantal != null) {
                        ...
                        if (isNaN(aantal)) {
                            ...
                            if (index >= 0) {
                                ...
                                var propname = artnr + kleur + maat;
                                var index2 = this.lookup_userdata[propertyname];
                                var oudaantal = 0;
                                if (index2 >= 0) {
                    ...
                    if (startindex != -1) {
                        for (var j = startindex; j < _this.all_voorraad["rows"].length; j++) {
                            if (_tthis.all_voorraad["rows"][j].values[art_idx] == _tthis.matrixtitle && _tthis.all_voorraad["rows"][j].values[dim1waarde_idx] == kleur
                                ...
                                if ((_row[attribute] <= 0) && _this.seizoen["iscurrent"] != "1") {
